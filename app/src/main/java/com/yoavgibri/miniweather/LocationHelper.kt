...
class LocationHelper {
    ...
    companion object {
        ...
        private const val KEY_LOCATION_UPDATES_REQUESTED: String = "location-updates-requested"
        ...
        fun setRequestingLocationUpdates(context: Context, requestUpdates: Boolean) {
            SP.putBoolean(KEY_LOCATION_UPDATES_REQUESTED, requestUpdates)
        }

        fun getRequestingLocationUpdates(context: Context): Boolean {
            return SP.getBoolean(KEY_LOCATION_UPDATES_REQUESTED, false)
        }
        ...
        private const val FASTEST_UPDATE_INTERVAL: Long = 30 * MINUTE
        private const val UPDATE_INTERVAL: Long = HOUR
        private const val MAX_WAIT_TIME: Long = 2 * HOUR
        ...
        fun checkLocationSettings(context: Context): Task<LocationSettingsResponse> {
            val locationSettingRequest = LocationSettingsRequest.Builder().addLocationRequest(createLocationRequest()).build()
